...
<head>
    ...
    <title>TAMBAH PRODUK PAWON NDESO</title>
...
<body>
    ...
    <br><br><br><br><br><br><section class="create" id="create">
        ...
        <table cellpadding ="10" cellspacing="0" class= "table table-striped">
             <tr>
                <td>ID Produk</td>
                <td><input id="input_ID" type="text" name="id_produk"> </td>
            </tr>
            <tr>
                <td>Gambar</td>
                <td><input id="input_gambar" type="file" name="gambar"> </td>
            </tr>
            <tr>
                <td>Nama Produk</td>
                <td><input id="input_nama"  type="text" name="nama_produk"></td>
            </tr>
            <tr>
                <td>Harga</td>
                <td><input id="input_harga" type="text" name="harga"></td>
            </tr>
            <tr>
                <td>Stok</td>
                <td><input id="input_stok" type="text" name="stok"></td>
            </tr>
            <tr>
                <td>Jenis Produk</td>
                <td><input id="input_jenis_produk" type="text" name="jenis_produk"></td>
            </tr>
            <tr>
                <td>ID Kategori</td>
                <td><input id="input_id_kategori" type="text" name="id_kategori"></td>
            </tr>
            <tr>
                <td></td>
                <td><button id="my-button" type="submit" class="btn btn-primary">Save</button></td>
            </tr>
        </table>
        </form>
        </div>
